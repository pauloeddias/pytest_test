...
#
#             # lambda_result_body = json.loads(lambda_result['body'])['order_list'][0]
#             lambda_result_body = lambda_result.get('order_list', [])[0]
...
#     test_pdfs = []
#     for obj in bucket.objects.filter(Prefix="surelogix/larson_mrgpod/"):
...
def test_larson():
    files_path = "surelogix/larson_mrgpod/"
