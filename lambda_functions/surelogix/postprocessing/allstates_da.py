...
class AllstatesDA(BasePostprocessor):
    ...
    def parse_output_format(self, **kwargs):
        ...
        self.output_format["goods"] = {
            "net_weight": self.ret.get("net_weight") if self.ret.get("net_weight") else None,
            "no_of_pieces": self.ret.get("no_of_pieces") if self.ret.get("no_of_pieces") else None,
            "pieces": [],
        }
